...
public class Uploadimage extends javax.swing.JFrame implements IUploadimage, IClassModels {
    ...
    public void CargarImagen(JLabel label, boolean valor, String imagen) {
        if (imagen == null) {
            if (valor) {
                ...
                urlOrigen = "H:\\nuevo\\SI-ProyectoManantial\\Papeleria Manantial\\sistema\\src\\Images\\fotos\\default.png";
            }
        } else {
            urlOrigen = imagen;
        }
    ...
    public void CopiarImagen(String fileName) {
        String imgDestino =  "H:\\nuevo\\SI-ProyectoManantial\\Papeleria Manantial\\sistema\\src\\Images\\fotos\\" + fileName + ".png";
        try {
            if (urlOrigen == null) {
                urlOrigen = "H:\\nuevo\\SI-ProyectoManantial\\Papeleria Manantial\\sistema\\src\\Images\\fotos\\default.png";
            }
